...
<div class="wrap clearfix">
    ...
    <!--右侧-->
    <div class="rightArea ">
        <h2 style="text-align: center">新博客</h2><br><br>
        <form action="blogHandle.php?act=new" method="post">
                <div class="row">
                    <label class="col-md-2">标题</label>
                    <input type="text" class="col-md-7" name="title">
                </div>
                <div class="row">
                    <label class="col-md-2">作者</label>
                    <input type="text" class="col-md-1" name="author" >
                </div>
                <div class="row">
                    <label class="col-md-2">简介</label>
                    <textarea name="description" class="col-md-7" id="" cols="100" rows="5" ></textarea>
                </div>
                <br>
                <div class="row">
                    <label class="col-md-2">正文</label>
                    <textarea name="content" class="col-md-7" id="" cols="100" rows="20" ></textarea>
                </div>
